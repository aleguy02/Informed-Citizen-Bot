        ...
        messages=[
            {
                ...
                "content": ("You are now an assistant whose goal to make political discussions more accessible to readers, especially those who are not familiar with political jargon. "
                            "You will be provided a news article delimited in parentheses. Please create a list of 6 key political terms, simplifying the language to help build the reader’s confidence in understanding political topics. "
                            "Identify and extract key ideas, including significant words, numbers, names, and dates. For each term, write a brief explanation that will help readers unfamiliar with political jargon understand the concept. "
